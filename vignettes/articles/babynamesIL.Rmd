...
This package contains Israeli baby names data from 1949-2024, covering four demographic sectors: Jewish, Muslim, Christian-Arab, and Druze.
...
We can plot names that are used for both male and female in a given year, e.g. 2024:
